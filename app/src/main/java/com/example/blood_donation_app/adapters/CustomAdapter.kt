package com.example.blood_donation_app.adapters
...
class CustomAdapter(private val mList: List<BloodDonorModel>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //holder.imageView.setImageResource(bloodDonor.getName())
